...
class DistributedQuadraticsObjective:
    ...
    def __init__(self, n, d, L=1, heterogeneity=1, r0=1, seed=1, mu=None):
        # print("====== DistributedQuadraticsObjective Initializing ======")
        ...
        # print("====== Running fork_rng_with_seed ======")
        ...
        with fork_rng_with_seed(seed):
            ...
            # print("====== Getting worker_optimum_offset_directions ======")
        ...
        # print("====== DistributedQuadraticsObjective Initialized ======")
    ...
    def _optimum(self) -> torch.Tensor:
        ...
        # opt, _ = torch.linalg.solve(A, B)
        opt = torch.linalg.solve(B, A)
...
class DistributedRandomLeastSquaresObjective:
    ...
    def _optimum(self) -> torch.Tensor:
        ...
        opt = torch.linalg.solve(self.AA.T @ self.AA, self.AA.T @ self.BB)
        return opt.unsqueeze(0)
